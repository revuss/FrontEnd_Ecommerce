...
export const Recommed = () => {
  return (
    <>
      <div className="text-center p-10">
        <h1 className="font-bold text-2xl mb-4">Recommended products</h1>
      </div>
      ...
      >
        <Card className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <Link to="/">
            <img
              src="https://images.pexels.com/photos/10147934/pexels-photo-10147934.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
              alt="Product"
              className="h-60 w-72 object-cover rounded-t-xl"
            />
            <CardContent className="px-4 py-3 w-72">
